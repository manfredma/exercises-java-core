...
public class SimpleLexer {
    ...
    private DfaState initToken(char ch) {
        if (tokenText.length() > 0) {
            ...
            tokens.add(token); // 将前一阶段的解析出来的 token 记下来
    ...
    public SimpleTokenReader tokenize(String code) {
        ...
        Reader reader = new CharArrayReader(code.toCharArray());
        tokenText = new StringBuffer();
        token = new SimpleToken();
        int ich;
        char ch = 0;
    ...
    private enum DfaState {
        ...
        If, Id_if1, Id_if2, Else, Id_else1, Id_else2, Id_else3, Id_else4, Int, Id_int1, Id_int2,
        Id_int3, Id, GT, GE,
