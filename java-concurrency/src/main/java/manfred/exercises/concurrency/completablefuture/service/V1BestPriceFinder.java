...
import manfred.exercises.concurrency.completablefuture.model.ExchangeService;
 ...
 */
public class V1BestPriceFinder {

    private final List<V1Shop> shops = Arrays.asList(new V1Shop("BestPrice"),
                                                   new V1Shop("LetsSaveBig"),
                                                   new V1Shop("MyFavoriteShop"),
                                                   new V1Shop("BuyItAll")/*,
                                                   new V1Shop("ShopEasy")*/);
